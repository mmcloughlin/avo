...
func TestContextInstructions(t *testing.T) {
	...
	ctx.GF2P8AFFINEINVQB(opimm8, opm128, opxmm)
	ctx.GF2P8AFFINEQB(opimm8, opm128, opxmm)
	ctx.GF2P8MULB(opimm8, opm128, opxmm)
	...
	ctx.VGF2P8MULB(opimm8, opm128, opxmm, opxmm)
	ctx.VGF2P8MULB_BCST(opimm8, opm64, opzmm, opk, opzmm)
