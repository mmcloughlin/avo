...
func TestContextInstructions(t *testing.T) {
	...
	ctx.VPDPBUSDS_BCST(opm64, opxmm, opk, opxmm)
	ctx.VPDPBUSDS_BCST_Z(opm64, opxmm, opk, opxmm)
	ctx.VPDPBUSDS_Z(opm128, opxmm, opk, opxmm)
	ctx.VPDPBUSD_BCST(opm64, opxmm, opk, opxmm)
	ctx.VPDPBUSD_BCST_Z(opm64, opxmm, opk, opxmm)
	ctx.VPDPBUSD_Z(opm128, opxmm, opk, opxmm)
	ctx.VPDPWSSD(opm128, opxmm, opk, opxmm)
	ctx.VPDPWSSDS(opm128, opxmm, opk, opxmm)
	ctx.VPDPWSSDS_BCST(opm64, opxmm, opk, opxmm)
	ctx.VPDPWSSDS_BCST_Z(opm64, opxmm, opk, opxmm)
	ctx.VPDPWSSDS_Z(opm128, opxmm, opk, opxmm)
	ctx.VPDPWSSD_BCST(opm64, opxmm, opk, opxmm)
	ctx.VPDPWSSD_BCST_Z(opm64, opxmm, opk, opxmm)
