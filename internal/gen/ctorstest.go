...
var validArgs = map[string][]string{
	...
	"m64/m32bcst":  {"operand.Mem{Base: reg.RBX, Index: reg.RCX, Scale: 8}"},
	"m128":         {"operand.Mem{Base: reg.RBX, Index: reg.RCX, Scale: 8}"},
	"m128/m32bcst": {"operand.Mem{Base: reg.RBX, Index: reg.RCX, Scale: 8}"},
	"m128/m64bcst": {"operand.Mem{Base: reg.RBX, Index: reg.RCX, Scale: 8}"},
	"m256":         {"operand.Mem{Base: reg.RBX, Index: reg.RCX, Scale: 8}"},
	"m256/m32bcst": {"operand.Mem{Base: reg.RBX, Index: reg.RCX, Scale: 8}"},
	"m256/m64bcst": {"operand.Mem{Base: reg.RBX, Index: reg.RCX, Scale: 8}"},
